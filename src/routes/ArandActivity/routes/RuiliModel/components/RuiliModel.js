...
//import '../../../../../plugins/swiper/ruili.swiper.min.js'
...
import pictureBox from '../../../../../style/img/arandActivity/ruiliModel/picture_box.png'
...
import swiper_2_1_min from '../../../../../style/img/arandActivity/ruiliModel/swiper_2_1_min.jpg'
import swiper_2_2_min from '../../../../../style/img/arandActivity/ruiliModel/swiper_2_2_min.jpg'
import swiper_2_3_min from '../../../../../style/img/arandActivity/ruiliModel/swiper_2_3_min.jpg'
import swiper_2_4_min from '../../../../../style/img/arandActivity/ruiliModel/swiper_2_4_min.jpg'
import swiper_2_5_min from '../../../../../style/img/arandActivity/ruiliModel/swiper_2_5_min.jpg'
import swiper_2_6_min from '../../../../../style/img/arandActivity/ruiliModel/swiper_2_6_min.jpg'
...
import swiper_3_1_min from '../../../../../style/img/arandActivity/ruiliModel/swiper_3_1_min.jpg'
import swiper_3_2_min from '../../../../../style/img/arandActivity/ruiliModel/swiper_3_2_min.jpg'
import swiper_3_3_min from '../../../../../style/img/arandActivity/ruiliModel/swiper_3_3_min.jpg'
import swiper_3_4_min from '../../../../../style/img/arandActivity/ruiliModel/swiper_3_4_min.jpg'
import swiper_3_5_min from '../../../../../style/img/arandActivity/ruiliModel/swiper_3_5_min.jpg'
import swiper_3_6_min from '../../../../../style/img/arandActivity/ruiliModel/swiper_3_6_min.jpg'
import swiper_3_7_min from '../../../../../style/img/arandActivity/ruiliModel/swiper_3_7_min.jpg'

import swiper_4_1 from '../../../../../style/img/arandActivity/ruiliModel/swiper_4_1.jpg'
...
import swiper_4_8 from '../../../../../style/img/arandActivity/ruiliModel/swiper_4_8.jpg'
import swiper_4_1_min from '../../../../../style/img/arandActivity/ruiliModel/swiper_4_1_min.jpg'
import swiper_4_2_min from '../../../../../style/img/arandActivity/ruiliModel/swiper_4_2_min.jpg'
import swiper_4_3_min from '../../../../../style/img/arandActivity/ruiliModel/swiper_4_3_min.jpg'
import swiper_4_4_min from '../../../../../style/img/arandActivity/ruiliModel/swiper_4_4_min.jpg'
import swiper_4_5_min from '../../../../../style/img/arandActivity/ruiliModel/swiper_4_5_min.jpg'
import swiper_4_6_min from '../../../../../style/img/arandActivity/ruiliModel/swiper_4_6_min.jpg'
import swiper_4_7_min from '../../../../../style/img/arandActivity/ruiliModel/swiper_4_7_min.jpg'
import swiper_4_8_min from '../../../../../style/img/arandActivity/ruiliModel/swiper_4_8_min.jpg'
        ...
        <div className={style.content1}>
        	...
        	<div className="pc-slide">
        		<img src={screen_4_title} />
						<div className="view">
							<a className="arrow-left" href="#"></a>
							<a className="arrow-right" href="#"></a>
							<div className="swiper-container">
								<img className="picture-box" src={pictureBox} />
								<div className="swiper-wrapper">
									<div className="swiper-slide">
										<img src={swiper_1_1} alt=""/>
									</div>
									<div className="swiper-slide">
										<img src={swiper_1_2} alt=""/>
									</div>
									<div className="swiper-slide">
										<img src={swiper_1_3} alt=""/>
									</div>
									<div className="swiper-slide">
										<img src={swiper_1_4} alt=""/>
									</div>
									<div className="swiper-slide">
										<img src={swiper_1_5} alt=""/>
									</div>
									<div className="swiper-slide">
										<img src={swiper_1_6} alt=""/>
									</div>
								</div>
							</div>
						</div>
							...
							<div className="swiper-container">
								<div className="swiper-wrapper">
									<div className="swiper-slide active-nav">
										<img src={swiper_1_1_min} alt=""/>
									</div>
									<div className="swiper-slide">
										<img src={swiper_1_2_min} alt=""/>
									</div>
									<div className="swiper-slide">
										<img src={swiper_1_3_min} alt=""/>
									</div>
									<div className="swiper-slide">
										<img src={swiper_1_4_min} alt=""/>
									</div>
									<div className="swiper-slide">
										<img src={swiper_1_5_min} alt=""/>
									</div>
									<div className="swiper-slide last-slide">
										<img src={swiper_1_6_min} alt=""/>
									</div>
								</div>
							</div>
						</div>
        		...
        		<img src={screen_5_title} />
						<div className="view2">
							...
							<div className="swiper-container">
								...
								<div className="swiper-wrapper">
									<div className="swiper-slide">
										<img src={swiper_2_1} alt=""/>
									</div>
									<div className="swiper-slide">
										<img src={swiper_2_2} alt=""/>
									</div>
									<div className="swiper-slide">
										<img src={swiper_2_3} alt=""/>
									</div>
									<div className="swiper-slide">
										<img src={swiper_2_4} alt=""/>
									</div>
									<div className="swiper-slide">
										<img src={swiper_2_5} alt=""/>
									</div>
									<div className="swiper-slide">
										<img src={swiper_2_6} alt=""/>
									</div>
								</div>
							</div>
						</div>
						<div className="preview2">
							...
							<div className="swiper-container">
								<div className="swiper-wrapper">
									<div className="swiper-slide active-nav">
										<img src={swiper_2_1_min} alt=""/>
									</div>
									<div className="swiper-slide">
										<img src={swiper_2_2_min} alt=""/>
									</div>
									<div className="swiper-slide">
										<img src={swiper_2_3_min} alt=""/>
									</div>
									<div className="swiper-slide">
										<img src={swiper_2_4_min} alt=""/>
									</div>
									<div className="swiper-slide">
										<img src={swiper_2_5_min} alt=""/>
									</div>
									<div className="swiper-slide last-slide">
										<img src={swiper_2_6_min} alt=""/>
									</div>
								</div>
							</div>
						</div>
        		...
        		<img src={screen_6_title} />
						<div className="view3">
							...
							<div className="swiper-container">
								...
								<div className="swiper-wrapper">
									<div className="swiper-slide">
										<img src={swiper_3_1} alt=""/>
									</div>
									<div className="swiper-slide">
										<img src={swiper_3_2} alt=""/>
									</div>
									<div className="swiper-slide">
										<img src={swiper_3_3} alt=""/>
									</div>
									<div className="swiper-slide">
										<img src={swiper_3_4} alt=""/>
									</div>
									<div className="swiper-slide">
										<img src={swiper_3_5} alt=""/>
									</div>
									<div className="swiper-slide">
										<img src={swiper_3_6} alt=""/>
									</div>
									<div className="swiper-slide">
										<img src={swiper_3_7} alt=""/>
									</div>
								</div>
							</div>
						</div>
						<div className="preview3">
							...
							<div className="swiper-container">
								<div className="swiper-wrapper">
									<div className="swiper-slide active-nav">
										<img src={swiper_3_1_min} alt=""/>
									</div>
									<div className="swiper-slide">
										<img src={swiper_3_2_min} alt=""/>
									</div>
									<div className="swiper-slide">
										<img src={swiper_3_3_min} alt=""/>
									</div>
									<div className="swiper-slide">
										<img src={swiper_3_4_min} alt=""/>
									</div>
									<div className="swiper-slide">
										<img src={swiper_3_5_min} alt=""/>
									</div>
									<div className="swiper-slide">
										<img src={swiper_3_6_min} alt=""/>
									</div>
									
									<div className="swiper-slide last-slide">
										<img src={swiper_3_7_min} alt=""/>
									</div>
								</div>
							</div>
						</div>
        		...
        		<img src={screen_7_title} />
						<div className="view4">
							...
							<div className="swiper-container">
								...
								<div className="swiper-wrapper">
									<div className="swiper-slide">
										<img src={swiper_4_1} alt=""/>
									</div>
									<div className="swiper-slide">
										<img src={swiper_4_2} alt=""/>
									</div>
									<div className="swiper-slide">
										<img src={swiper_4_3} alt=""/>
									</div>
									<div className="swiper-slide">
										<img src={swiper_4_4} alt=""/>
									</div>
									<div className="swiper-slide">
										<img src={swiper_4_5} alt=""/>
									</div>
									<div className="swiper-slide">
										<img src={swiper_4_6} alt=""/>
									</div>
									<div className="swiper-slide">
										<img src={swiper_4_7} alt=""/>
									</div>
									<div className="swiper-slide">
										<img src={swiper_4_8} alt=""/>
									</div>
								</div>
							</div>
						</div>
						<div className="preview4">
							...
							<div className="swiper-container">
								<div className="swiper-wrapper">
									<div className="swiper-slide active-nav">
										<img src={swiper_4_1_min} alt=""/>
									</div>
									<div className="swiper-slide">
										<img src={swiper_4_2_min} alt=""/>
									</div>
									<div className="swiper-slide">
										<img src={swiper_4_3_min} alt=""/>
									</div>
									<div className="swiper-slide">
										<img src={swiper_4_4_min} alt=""/>
									</div>
									<div className="swiper-slide">
										<img src={swiper_4_5_min} alt=""/>
									</div>
									<div className="swiper-slide">
										<img src={swiper_4_6_min} alt=""/>
									</div>
									<div className="swiper-slide">
										<img src={swiper_4_7_min} alt=""/>
									</div>
									<div className="swiper-slide last-slide">
										<img src={swiper_4_8_min} alt=""/>
									</div>
								</div>
							</div>
						</div>
  ...
  componentDidMount() {
    	...
    	ruiliPlayer1 = new YKU.Player('ruiliPlayer1',{
			...
			setTimeout(function(){
				...
				var previewSwiper = new RuiliSwiper('.preview .swiper-container', {
				...
				var viewSwiper2 = new RuiliSwiper('.view2 .swiper-container', {
					onSlideChangeStart: function() {
						updateNavPosition2()
					}
				})
				...
				$('.view2 .arrow-left,.preview2 .arrow-left').on('click', function(e) {
					...
					if (viewSwiper2.activeIndex == 0) {
						viewSwiper2.swipeTo(viewSwiper2.slides.length - 1, 1000);
						return
					}
					viewSwiper2.swipePrev()
				})
				$('.view2 .arrow-right,.preview2 .arrow-right').on('click', function(e) {
					e.preventDefault()
					if (viewSwiper2.activeIndex == viewSwiper2.slides.length - 1) {
						viewSwiper2.swipeTo(0, 1000);
						return
					}
					viewSwiper2.swipeNext()
				})
				
				var previewSwiper2 = new RuiliSwiper('.preview2 .swiper-container', {
					visibilityFullFit: true,
					slidesPerView: 'auto',
					onlyExternal: true,
					onSlideClick: function() {
						viewSwiper2.swipeTo(previewSwiper2.clickedSlideIndex)
					}
				})
				...
				function updateNavPosition2() {
					...
					if (!activeNav.hasClass('swiper-slide-visible')) {
						if (activeNav.index() > previewSwiper2.activeIndex) {
							...
							previewSwiper2.swipeTo(activeNav.index() - thumbsPerNav)
						} else {
							previewSwiper2.swipeTo(activeNav.index())
						}
					}
				}
				
				var viewSwiper3 = new RuiliSwiper('.view3 .swiper-container', {
					onSlideChangeStart: function() {
						updateNavPosition3()
					}
				})
				...
				$('.view3 .arrow-left,.preview3 .arrow-left').on('click', function(e) {
					...
					if (viewSwiper3.activeIndex == 0) {
						viewSwiper3.swipeTo(viewSwiper3.slides.length - 1, 1000);
						return
					}
					viewSwiper3.swipePrev()
				})
				$('.view3 .arrow-right,.preview3 .arrow-right').on('click', function(e) {
					e.preventDefault()
					if (viewSwiper3.activeIndex == viewSwiper3.slides.length - 1) {
						viewSwiper3.swipeTo(0, 1000);
						return
					}
					viewSwiper3.swipeNext()
				})
				
				var previewSwiper3 = new RuiliSwiper('.preview3 .swiper-container', {
					visibilityFullFit: true,
					slidesPerView: 'auto',
					onlyExternal: true,
					onSlideClick: function() {
						viewSwiper3.swipeTo(previewSwiper3.clickedSlideIndex)
					}
				})
				...
				function updateNavPosition3() {
					...
					if (!activeNav.hasClass('swiper-slide-visible')) {
						if (activeNav.index() > previewSwiper3.activeIndex) {
							...
							previewSwiper3.swipeTo(activeNav.index() - thumbsPerNav)
						} else {
							previewSwiper3.swipeTo(activeNav.index())
						}
					}
				}
				
				var viewSwiper4 = new RuiliSwiper('.view4 .swiper-container', {
					onSlideChangeStart: function() {
						updateNavPosition4()
					}
				})
				
				$('.view4 .arrow-left,.preview4 .arrow-left').on('click', function(e) {
					e.preventDefault()
					if (viewSwiper4.activeIndex == 0) {
						viewSwiper4.swipeTo(viewSwiper4.slides.length - 1, 1000);
						return
					}
					viewSwiper4.swipePrev()
				})
				$('.view4 .arrow-right,.preview4 .arrow-right').on('click', function(e) {
					e.preventDefault()
					if (viewSwiper4.activeIndex == viewSwiper4.slides.length - 1) {
						viewSwiper4.swipeTo(0, 1000);
						return
					}
					viewSwiper4.swipeNext()
				})
				
				var previewSwiper4 = new RuiliSwiper('.preview4 .swiper-container', {
					visibilityFullFit: true,
					slidesPerView: 'auto',
					onlyExternal: true,
					onSlideClick: function() {
						viewSwiper4.swipeTo(previewSwiper4.clickedSlideIndex)
					}
				})
				
				function updateNavPosition4() {
					$('.preview4 .active-nav').removeClass('active-nav')
					var activeNav = $('.preview4 .swiper-slide').eq(viewSwiper4.activeIndex).addClass('active-nav')
					if (!activeNav.hasClass('swiper-slide-visible')) {
						if (activeNav.index() > previewSwiper4.activeIndex) {
							var thumbsPerNav = Math.floor(previewSwiper4.width / activeNav.width()) - 1
							previewSwiper4.swipeTo(activeNav.index() - thumbsPerNav)
						} else {
							previewSwiper4.swipeTo(activeNav.index())
						}
					}
				}
			},1000);
