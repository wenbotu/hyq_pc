...
class Test extends Component {
  ...
  componentDidMount() {
	  ...
	  /*$.ajax({
				...
				success: function(data) {
					...
					console.log(data)
					this.setState({service:data.data[0]})
				}.bind(this),
				error:function(data){
					console.log("error");
				},
  ...
  shouldComponentUpdate(nextProps, nextState){
  	console.log(this.props.id + "_" + nextProps.id)
  	//console.log(this.state)
  	//console.log(nextState)
  	//return false
  	console.log(global.serviceCateId)
  	console.log(global.serviceCateId + "_" + this.props.id)
  	console.log('XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX')
  	console.log(this.props)
  	console.log(nextProps)
  	//console.log(nextProps+'__'+this.props)
  	//return nextProps.service.addTime !== this.props.service.addTime
  	return false
  	//return true
  }
}
